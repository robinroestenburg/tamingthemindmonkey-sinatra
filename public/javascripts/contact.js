  ...
  jQuery(".contactButton").click(function() {
    ...
    jQuery("input#contactEmail").focus();
      ...
      success: function() {
        ...
        jQuery('#successMessage').html("<img src='images/icons/cloud-upload.png' alt='' style='float:left; margin-top:4px; margin-right:10px;'/><strong style='float:left; margin-top:3px;'>Message Has Been Sent!</strong>")
        .append("<p style='float:left; margin-bottom:30px;'>We'll get back to you shortly! Please be patient!</p>")
        .hide()
